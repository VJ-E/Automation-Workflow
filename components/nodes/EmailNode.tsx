...
export function EmailNode({ data }: EmailNodeProps) {
    return (
        <div className="w-64 bg-white dark:bg-[#F59E0B] border-2 border-slate-200 dark:border-[#D97706] rounded-xl shadow-lg transition-all hover:shadow-xl hover:border-slate-300 dark:hover:border-[#D97706]">
            {/* Input Handle */}
            <Handle
                type="target"
            ...
            {/* Header */}
            <div className="flex items-center gap-3 p-3 border-b border-slate-100 dark:border-[#D97706]">
                <div className="p-2 rounded-lg bg-amber-50 dark:bg-white/20 text-amber-600 dark:text-white">
                    <Mail size={18} />
                </div>
                <div>
